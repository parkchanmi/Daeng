...
public class DBCPInit extends HttpServlet {
	...
	public void init() throws ServletException {
		loadJDBCDriver(); //드라이버로딩
		initConnectionPool(); //커넥션연결
	}

	private void loadJDBCDriver() { // 드라이버로딩
		try {
	...
	private void initConnectionPool() {
		try {
			String jdbcUrl = "jdbc:oracle:thin:@192.168.40.58:1521:XE";
			String username = "daeng";
			String pw = "daeng";
