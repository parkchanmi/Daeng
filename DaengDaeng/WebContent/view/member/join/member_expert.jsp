		...
		<div id="contents_mypage">
			<div class="mypageform">
				...
				<div class="member_choice">
					<form method="post" action="member_expert_pro.do" name="userinput"
						onsubmit="return checkIt()">
						<ul class="mp_modify_pwForm">
							<li><label>E-mail</label> <input type="text"
								name="mem_email" size="15" maxlength="30">
								<div class="btn_area03">
									<input type="button" name="confirm_email" value="중복확인"
										class="btn_confirm01"
										OnClick="openConfirmmem_email(this.form)"> <input
										type="hidden" name="mem_emailcheck" value="0">
								</div></li>
							<li><label>인증번호</label>
							...
							<li><label for="password">비밀번호</label> <input
								type="password" name="mem_pw" size="15" maxlength="12">
							</li>
							<li><label for="password">비밀번호 확인</label> <input
								type="password" name="mem_pw2" size="15" maxlength="12">
							</li>
							<li><label>닉네임</label> <input type="text" name="mem_name"
								size="15" maxlength="10">
								<div class="btn_area03">
									<input type="button" name="confirm_email" value="중복확인"
										class="btn_confirm" OnClick="openConfirmmem_name(this.form)">
									<input type="hidden" name="mem_namecheck" value="0">
								</div></li>
							<li><label>성별</label> <input type="radio" id="radio"
								name="mem_gender" value="남"> <span>남</span> <input
								type="radio" name="mem_gender" value="여"> <span>여</span>
							</li>
							<li><label>연령대</label> <input type="radio" name="mem_age"
								value="10대"> <span>10대</span> <input type="radio"
								name="mem_age" value="20대"> <span>20대</span>. <input
								type="radio" name="mem_age" value="30대"> <span>30대</span>
								<input type="radio" name="mem_age" value="40대"> <span>40대</span>
								<input type="radio" name="mem_age" value="50대이상"> <span>50대이상</span>
							</li>
							<li><label>핸드폰</label> <select name="hp1" id="hp_1">
									<option value="010">010</option>    
									<option value="011">011</option>
							</select> - <input type="text_num" name="hp2" size="4" maxlength="4"
								onkeypress="onlyNumber()"> - <input type="text_num"
								name="hp3" size="4" maxlength="4" onkeypress="onlyNumber()">
							</li>
							<li><label>지역</label> <select name="mem_loc">
							...
							<li><label>유입경로</label> <input type="radio" name="mem_visit"
								value="검색"> <span>검색</span> <input type="radio"
								name="mem_visit" value="지인추천"> <span>지인추천</span> <input
								type="radio" name="mem_visit" value="광고"> <span>광고</span>
								<input type="radio" name="mem_visit" value="SNS"> <span>SNS</span>
								<input type="radio" name="mem_visit" value="기타"> <span>기타</span>
							</li>
						</ul>
						<ul class="mp_modify_pwForm">
							<h2 class="pet_info" style="margin-bottom:15px;">전문가</h2>
							<ul class="mp_modify_pwForm">
								<ul>
									<li><label>전문분야</label> <select name="mem_job">
						...
						<div class="btn_area_join">
							<input type="submit" name="confirm" value="가  입"
								class="btn_dogs_modify"> <input type="reset"
								name="reset" value="다시입력" class="btn_dogs_delete">
						</div>
