			...
			<div class="clublist_form">
				...
				<div class="club_list">
					<table width="965" cellpadding="0" cellspacing="0" align="center">
						<thead style="background-color:#EE8300;  color:#fff;">	
							<tr height="35">
								...
								<th align="center" width="100">소개</th>
								<th align="center" width="30">개설날짜</th>
							</tr>
						</thead>
						<c:forEach var="clublist" items="${cList}">
							<tr height="35">
								...
								<td><a href="/DaengDaeng/club/detail/club_board.do?cicode=${clublist.ci_code}">${clublist.ci_name}</a></td>
					...
					<div class="btn_clublist">
						<button onclick="javascript:location.href='/DaengDaeng/club/myclub_list.do'" id="join_cl">가입한소모임</button>
						<button onclick="javascript:location.href='/DaengDaeng/club/create_clubForm.do'" id="make_cl">소모임만들기</button>
						<button onclick="javascript:location.href='/DaengDaeng/club/club_list.do'" id="totallist_cl">전체목록</button>
					</div>
				</div>
			</div>
		</div>
