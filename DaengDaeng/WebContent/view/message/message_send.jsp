...
<link href="/DaengDaeng/css/msg_send_list.css" rel="stylesheet"
	type="text/css">
							...
							<c:if test="${message_list!=null }">
								...
								<c:forEach var="msglist" items="${message_list}">
									<tr>
										...
										<td width="250">${msglist.msg_receiver_name}</td>
										<td align="center" width="150"><a
											href="/DaengDaeng/message/message_contents.do?msgID=${msglist.msg_code}">${msglist.msg_title}</a></td>
