			...
			<div class="board_qna">
				...
				<div class="write_area_qna">
					<form method="post" name="writeform"
						action="/DaengDaeng/board/lost/finder/finder_updatePro.do?pageNum=${pageNum}" onsubmit="summer()">
						...
						<div class="write_box_qna">
							...
							<div class="btn_write_qna">
								<input type="submit" value="글수정"> <input type="reset"
									...
									OnClick="window.location='/DaengDaeng/board/lost/finder/finder_list.do?pageNum=${pageNum}'">
							</div>
						</div>
					</form>
					</div>
