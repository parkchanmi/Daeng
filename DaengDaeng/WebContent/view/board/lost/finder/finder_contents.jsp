	...
	<div id="wrapper">
		...
		<div id="contents_qnaRev">
			<div class="contents_qna_area">
				<form>
					<input type="hidden" name="lost_type" value="주인 찾기">
					<ul class="qnaRev_ul">
					...
					<c:if test="${memberDTO.mem_code==article.lost_writer }">
						<input type="button" value="글수정"
							onclick="document.location.href='/DaengDaeng/board/lost/finder/finder_updateForm.do?num=${article.lost_code}&pageNum=${pageNum}'">
						<input type="button" value="글삭제"
							onclick="document.location.href='/DaengDaeng/board/lost/finder/finder_deletePro.do?num=${article.lost_code}&pageNum=${pageNum}'">
							</c:if>
						<input type="button" value="글목록"
							onclick="document.location.href='/DaengDaeng/board/lost/finder/finder_list.do?pageNum=${pageNum}'">
				...
				<div class="contents_review_area">
					<table>
						<form method="post" name="review"
							action="/DaengDaeng/board/lost/finder/finderReviewPro.do?num=${article.lost_code}&pageNum=${pageNum}">
							<div class="rev_title">
							...
							<div class="rev_commbox">
								...
								<input type=hidden name="rev_typecode" value="주인 찾기">
							</div>
						</form>
					</table>
					...
					<c:forEach var="review_finder" items="${articleList}">
						<tr height="23">
							...
							<td><input type="button" value="삭제"
								onclick="document.location.href='/DaengDaeng/board/lost/finder/finderReviewDelete.do?num=${article.lost_code}&pageNum=${pageNum}&rev_num=${review_finder.rev_num}'"></td>
							</c:if>
							<c:if test="${memberDTO.mem_code!=review_finder.rev_memcode }">
							<td>&nbsp;</td>
							</c:if>
