			...
			<div class="board_qna">
				...
				<div class="write_area_qna">
					<form method="post" name="writeform_qna"
						action="/DaengDaeng/board/qna/updatePro.do" onsubmit="summer();">
						<input type="hidden" name="num" value="${article.board_num}">
						...
						<ul>
							...
							<h3><input type="text" size="40" maxlength="50" name="board_title" value="${article.board_title }"></h3> 
