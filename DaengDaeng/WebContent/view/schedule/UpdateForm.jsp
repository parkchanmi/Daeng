...
<%-- Form                                                                                       --%>
<%--------------------------------------------------------------------------------------------- --%>
<FORM method="post" name="theForm" action="/DaengDaeng/view/schedule/Update.jsp" style="margin:0">
		...
		<TR>
			...
			<TABLE cellpadding="5" cellspacing="1" border="0" bgcolor="#666666">
				...
				<TR bgcolor="#ffffff">
					...
					<TD width="380">
						<INPUT type="text" name="sch_title" class="text_gray" size="30" maxlength="50" value='<c:out value="${sch_title}"/>'>
					</TD>
				</TR>
				<TR bgcolor="#ffffff">
					<TD class="main">
					...
					<TD>
						<TEXTAREA NAME="sch_contents" class="textarea" ROWS="12" COLS="52" WRAP="VIRTUAL"><c:out value="${sch_contents}"/></TEXTAREA>
					</TD>
				</TR>
			</TABLE>
			</TD>   
...
<INPUT type="hidden" name="sch_sdate">
</FORM>
</CENTER>
</BODY>
<%--------------------------------------------------------------------------------------------- --%>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function checkAction(){
		return (   
				...
				&& checkBlankMessage(document.theForm.sch_title , '제목을 입력 하십시오')
				&& checkBlankMessage(document.theForm.sch_contents , '내용을 입력 하십시오')
		);
	}

	function submitForm(command) {
		document.theForm.sch_sdate.value = 
